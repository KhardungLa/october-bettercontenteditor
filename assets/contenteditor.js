...
},{}],"RevisionTool.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  mounted: function mounted() {},
  methods: {
    setEditMode: function setEditMode(state) {
    ...
    setData: function setData(file, component) {
      this.file = file;
    ...
    getRevisions: function getRevisions() {
      ...
      $.request(this.component, {
        ...
        success: function success(data) {
          setTimeout(function () {
            var emptyElements = document.querySelector("*[data-file=\"".concat(_this.file, "\"] .ce-element--empty"));

            if (emptyElements) {
              emptyElements.remove();
            }

            var oldContent = ContentTools.EditorApp.get().regions();

            if (oldContent[_this.file]) {
              _this.currentRegion = oldContent[_this.file];
              _this.currentVersion = _this.currentRegion.html();

              if (_this.isFixture) {
                _this.currentVersion = $(_this.currentVersion)[0].innerHTML.trim();
              }
            } else {
              _this.hasRevision = false;
            }
          }, 200);
          _this.revisions = data.filter(function (revision) {
            return revision.old_value !== null;
          });
          _this.hasRevision = _this.revisions.length > 0;
        }
      });
    },
    setRevision: function setRevision(index) {
      var _this2 = this;

      var newContent = index === -1 ? this.currentVersion : this.revisions[index].old_value;

      if (this.isFixture) {
        document.querySelector("*[data-file=\"".concat(this.file, "\"]")).innerHTML = newContent;
      } else {
        this.currentRegion.setContent(newContent);
      }

      setTimeout(function () {
        var emptyElements = document.querySelector("*[data-file=\"".concat(_this2.file, "\"] .ce-element--empty"));
...
exports.default = _default;
        var $867c78 = exports.default || module.exports;
      
      if (typeof $867c78 === 'function') {
        $867c78 = $867c78.options;
      }
    
        /* template */
        Object.assign($867c78, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c(
    ...
    [
      _c("div", {
        staticClass: "revision-selector ct-tool ct-tool--clock",
        class: {
          "ct-tool--disabled": !_vm.active,
          "ct-tool--applied": _vm.editMode
        },
        on: {
        ...
        _vm.editMode
          ? _c("div", { staticClass: "selector" }, [
              _c(
                ...
                {
                  staticClass:
                    "uk-nav uk-nav-default revision-list uk-text-right"
                },
                [
                  _c(
                    "li",
                    {
                      class: { "uk-active": _vm.setVersion === -1 },
                      on: {
                        click: function($event) {
                          return _vm.setRevision(-1)
                        }
                      }
                    },
                    [_vm._v(_vm._s(_vm.translations.current))]
                  ),
                  _vm._v(" "),
                  _vm._l(_vm.revisions, function(revision, index) {
                    return _c(
                      "li",
                      {
                        class: { "uk-active": _vm.setVersion === index },
                        on: {
                          click: function($event) {
                            return _vm.setRevision(index)
                          }
                        }
                      },
                      [
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$867c78', $867c78);
          } else {
            api.reload('$867c78', $867c78);
          }
        }
...
},{"_css_loader":"../../../../../../../../../../usr/local/lib/node_modules/parcel/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"contenteditor.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"./images/move.svg":[["move.b23af7ab.svg","images/move.svg"],"images/move.svg"],"./images/pencil.svg":[["pencil.04cc3361.svg","images/pencil.svg"],"images/pencil.svg"],"./images/check.svg":[["check.4b7c2681.svg","images/check.svg"],"images/check.svg"],"./images/close.svg":[["close.4440cd52.svg","images/close.svg"],"images/close.svg"],"_css_loader":"../../../../../../../../../../usr/local/lib/node_modules/parcel/src/builtins/css-loader.js"}],"samuell.js":[function(require,module,exports) {
/*
* Load ContentTools
*/
var editor = ContentTools.EditorApp.get();
editor.init('[data-editable], [data-fixture]', 'data-file', function (domElement) {
...
function imageUploader(dialog) {
  var image, xhr, _xhrComplete2, xhrProgress; // Image rotate
  ...
  dialog.addEventListener('imageuploader.cancelUpload', function () {
    ...
    if (xhr) {
      ...
      xhr.removeEventListener('readystatechange', _xhrComplete2);
      xhr.abort();
  ...
  dialog.addEventListener('imageuploader.fileready', function (ev) {
    ...
    var formData;
    var file = ev.detail().file; // Define functions to handle upload progress and completion

    xhrProgress = function xhrProgress(ev) {
      // Set the progress for the upload
      dialog.progress(ev.loaded / ev.total * 100);
    };

    _xhrComplete2 = function xhrComplete(ev) {
      var response; // Check the request is complete
      ...
      xhr = null;
      xhrProgress = null;
      _xhrComplete2 = null; // Handle the result of the upload
    ...
    dialog.progress(0); // Build the form data to post to the server

    formData = new FormData();
    formData.append('image', file); // Make the request

    xhr = new XMLHttpRequest();
    xhr.upload.addEventListener('progress', xhrProgress);
    xhr.addEventListener('readystatechange', _xhrComplete2);
    xhr.open('POST', siteUrl + '/contenteditor/image/upload', true);
    xhr.send(formData);
  }); // Image save

  dialog.addEventListener('imageuploader.save', function () {
    var crop, cropRegion, formData; // Define a function to handle the request completion

    _xhrComplete2 = function _xhrComplete(ev) {
      ...
      xhr = null;
      _xhrComplete2 = null; // Free the dialog from its busy state

      dialog.busy(false); // Handle the result of the rotation

      if (parseInt(ev.target.status) === 200) {
        // Unpack the response (from JSON)
        var response = JSON.parse(ev.target.responseText); // Trigger the save event against the dialog with details of the
        // image to be inserted.

        dialog.save(response.filePath, response.size, {
          'alt': response.alt,
    ...
    dialog.busy(true); // Build the form data to post to the server
    ...
    formData.append('alt', image.alt); // Check if a crop region has been defined by the user
...
},{}],"contenteditor.js":[function(require,module,exports) {
"use strict";
...
var _RevisionTool = _interopRequireDefault(require("./RevisionTool"));
...
_vue$.default.config.shadowRoot = true;
...
new _vue$.default({
  ...
  mounted: function mounted() {
    ...
    var editor = ContentTools.EditorApp.get();
    editor.addEventListener('revert', function (e) {
      e.preventDefault();
    ...
    editor.addEventListener('start', function (e) {
      setTimeout(function () {
        ...
        _this2.history = historyButton;
        _this2.revision = new _vue$.default({
          render: function render(h) {
            return h(_RevisionTool.default);
          }
        }).$mount(historyButton);
      }, 100);
    });
    editor.addEventListener('saved', function (ev) {
      ...
      for (var name in regions) {
        if (regions.hasOwnProperty(name)) {
          var content = document.querySelector('*[data-file="' + name + '"]');
          var isFixture = content.hasAttribute('data-fixture');
          var htmlData = isFixture ? content.innerHTML.trim() : regions[name];
          $.request(content.getAttribute('data-component'), {
            data: {
              file: name,
              content: htmlData
            }
      ...
      _uikit.default.notification(document.contentEditorTranslations.changesSaved);
    ...
    setTimeout(function () {
      ContentEdit.Root.get().bind('focus', function (element) {
        var dataset = element._parent._domElement.dataset;

        if (dataset.getrevisions) {
          _this2.revision.$children[0].editMode = false;
          _this2.revision.$children[0].file = dataset.file;
          _this2.revision.$children[0].component = dataset.getrevisions;
          _this2.revision.$children[0].isFixture = dataset.fixture !== undefined;
          _this2.revision.$children[0].active = true;
        } else {
          _this2.revision.$children[0].active = false;
        }
      });
    }, 1000);
  },
  methods: {
    askToClose: function askToClose() {
      var _this3 = this;

      if (editor._rootLastModified && ContentEdit.Root.get().lastModified() > editor._rootLastModified) {
        _uikit.default.modal.confirm(document.contentEditorTranslations.changesLost, {
          labels: {
    ...
    elementSelected: function elementSelected(file) {
      console.log(file);
    }
  }
}).$mount('#content-editor-app');
},{"vue$":"node_modules/vue/dist/vue.min.js","uikit":"node_modules/uikit/dist/js/uikit.js","./RevisionTool":"RevisionTool.vue","./contenteditor.scss":"contenteditor.scss","./samuell.js":"samuell.js"}],"../../../../../../../../../../usr/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../../../../../../../usr/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js","contenteditor.js"], null)
