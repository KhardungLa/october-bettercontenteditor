...
class Settings extends Model
{
    ...
    public $settingsCode = 'dasrotequadrat_bettercontenteditor_settings';

    public $settingsFields = 'fields.yaml';

    const CACHE_KEY = 'dasrotequadrat.bettercontenteditor.additional_styles';

    public function initSettingsData()
    {
        $this->additional_styles = File::get(plugins_path() . '/dasrotequadrat/bettercontenteditor/assets/additional-css.css');
    }
